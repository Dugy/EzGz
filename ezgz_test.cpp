...
int main(int, char**) {
...

	{
		...
		};
		{
			...
			Detail::Deduplicator<TestStreamSettings<10, 4>, Detail::DeduplicationBloomFilter<>, INDEX_DUPLICATES> deduplicator(byteReader, output);
...

	{
		...
		DeduplicationVerifier<TestStreamSettings<12, 5>> verifier;
		{
			...
			Detail::Deduplicator<TestStreamSettings<12, 5>, Detail::DeduplicationBloomFilter<>, INDEX_DUPLICATES> deduplicator(byteReader, output);
			deduplicator.deduplicateSome();
		}
